...
var   nomePessoa  = "Diego";   // não recomendado
let   idade       = 28;         // pode mudar o valor
...
let pokemon = "Lucario"
let PokeFavorido = `Meu pokemon favorito é ${pokemon}!`

console.log(saudacao);
console.log(linguagem);
console.log(templateString);
console.log(typeof saudacao); // "string"
console.log(PokeFavorido)
console.log("_______________________________");
