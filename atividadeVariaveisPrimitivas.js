...
// → Seu código aqui:
var meuNome = "Diego"
var naoUsarVar = "Var não deve ser usado pois é uma linguagem em desuso no JavaScript"
let minhaIdade = 28
const ANO_NASCIMENTO = 1997
console.log(meuNome)
...
// O typeof returna o null como objeto porque é uma regra do JS
...
let idade1 = 28
let altura1 = 1.78
let cidade1 = "Guaramirim"
let estudandoJs = true
let frase = `Olá! Meu nome é ${nome1}, tenho ${idade1} anos, moro em ${cidade1} \nmeço ${altura1}m e estou estudando JavaScript: ${estudandoJs}`
console.log(frase)
console.log("_______________________________");